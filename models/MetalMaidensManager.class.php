...
class MetalMaidensManager
{
	...
	public function add( MetalMaiden $metalMaiden ) {
		...
		$query->bindValue(':ammo', implode(',', $metalMaiden->getAmmo()));
		$query->bindValue(':lifestyle_skills', implode(',', $metalMaiden->getLifestyle_skills()));
		$query->bindValue(':equipment_slots', implode(',', $metalMaiden->getEquipment_slots()));
		$query->bindValue(':engine_bonus', implode(',', $metalMaiden->getEngine_bonus()));
		$query->bindValue(':chassis_bonus', implode(',', $metalMaiden->getChassis_bonus()));
